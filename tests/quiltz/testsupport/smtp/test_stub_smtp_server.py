...
class TestSMTPStubServer:
    ...
    def test_collects_message_for_recipient(self):        
        message = a_message(recipient='rob@mailinator.com', sender='no-reply@qwan.eu', subject='test', body='hello test')
    ...
    def test_collects_multiple_messages_to_recipient(self):        
        messages = [
          a_message(recipient='rob@mailinator.com', sender='no-reply@qwan.eu', subject='rob', body='hello rob'),
          a_message(recipient='henk@mailinator.com', sender='no-reply@qwan.eu', subject='henk', body='hello henk'),
        ]
